...
export class UserService {
  ...
  constructor(
   ...
   restoreAcc(){
    ...
    this.tempAcc.getShape().setCheast(localStorage.getItem('breast'));
    this.tempAcc.getShape().setHeight(localStorage.getItem('height'));
    this.tempAcc.getShape().setSkinColor(localStorage.getItem('skin'));
    this.tempAcc.getShape().setThigh(localStorage.getItem('thigh'));
    this.tempAcc.getShape().setWeist(localStorage.getItem('waist'));
